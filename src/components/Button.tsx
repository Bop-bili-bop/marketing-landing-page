  ...
  return (
    <button
      ...
      className={classNames(
        "text-center font-medium text-base px-5 py-3 shadow-md ring-0 focus:ring-4 focus:ring-[#444ce7]/12 outline-none rounded-md gap-1.5 cursor-pointer disabled:bg-gray-100 disabled:text-gray-400 disabled:shadow-none disabled:cursor-not-allowed",
        styles[variant],
        className
      )}
    >
